...
def db_seed():
    ...
    test_user = User(first_name = 'Willy',
                     last_name = 'Herschel',
                     email = 'test@test.com',
                     password = 'admin')
...
@app.route('/planets',methods=['GET']) # methods tells which methods are allowed at this url
def planets():
...
def add_planet():
    ...
    if test:
        return jsonify(message="There was already a planet by that name"), 409
    else:
...
# instantiate 2 different versions of each class
