...
folder = "/Users/anthonyolund/springboard/guided_capstone/"
...
trade.write.partitionBy("trade_dt").mode("overwrite").parquet("wasbs://output@aoopenendedcaptstone.blob.core.windows.net/output")
...
quote.write.partitionBy("trade_dt").mode("overwrite").parquet("wasbs://output@aoopenendedcaptstone.blob.core.windows.net/output")